...
void Principal::InicializaDept()
{
	...
	Matematica_Cam.setDept("Mateática");
...
void Principal::InicializaAlunos()
{
	...
	Mariana.start(15, 7, 2008, "Mariana Gon�alves");
	LAlunos.incluaAluno(&Mariana);
	Maria.start(10, 5, 2001, "Maria Fran�a");
...
void Principal::InicializaDisciplinas()
{
    ...
    TECPROG.setNome("Tecnicas de Programa��o");
    FUNDAMENTOS.setNome("Fundamentos de Programa��o 1");
...
void Principal::CadDisciplina()
{
    ...
    else{ cout << "Departamento inv�lido!" << endl; getchar();}
    getchar();
...
void Principal::CadDepartamento ()
{
    ...
    else{cout << "Universidade inv�lida!" << endl;}
    getchar();
}
void Principal::CadAluno ()
{
    ...
    if(LDisc.contaDisc() != 0){
        ...
        else{cout << "Disciplina inv�lida!" << endl;}
    }
...
void Principal::MenuCad()
{
    ...
    while(op_menu != 5)
    {
        ...
        switch(op_menu){
            ...
            default:{ cout << " Caractere Inv�lido!" << endl; getchar(); }
...
void Principal::Menu()
{
    ...
    while(op_menu != 3)
    {
        ...
        cout << "-------------- Bem vindo ao Sistema Acad�mico! -------------- \n" << endl;
